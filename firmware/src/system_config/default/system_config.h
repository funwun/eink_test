...
#define SYS_PORT_B_ANSEL        0xe05
#define SYS_PORT_B_TRIS         0xffcd
#define SYS_PORT_B_LAT          0x10
#define SYS_PORT_B_ODC          0x8
#define SYS_PORT_B_CNPU         0x0
#define SYS_PORT_B_CNPD         0x0
#define SYS_PORT_B_CNEN         0x100
#define SYS_PORT_C_ANSEL        0x0
#define SYS_PORT_C_TRIS         0x9000
